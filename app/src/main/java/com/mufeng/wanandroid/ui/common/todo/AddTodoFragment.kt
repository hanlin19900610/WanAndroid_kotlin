...
import com.mufeng.wanandroid.utils.ext.formatCurrentDate
import com.mufeng.wanandroid.utils.ext.showToast
import com.mufeng.wanandroid.utils.ext.stringToCalendar
...
class AddTodoFragment : BaseMvpFragment<AddTodoContract.View, AddTodoContract.Presenter>(),
    ...
    override val createPresenter: AddTodoContract.Presenter?
        get() = AddTodoPresenter()
