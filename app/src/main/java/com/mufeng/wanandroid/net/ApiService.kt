...
import com.mufeng.wanandroid.bean.*
...
interface ApiService {
     ...
     */
    @GET("tree/json")
    fun getKnowledge(): Observable<HttpResult<List<KnowledgeTreeBody>>>
    ...
    fun getArticleListList(@Path("page") page: Int, @Query("cid") cid: Int): Observable<HttpResult<ArticleResponseBody>>
